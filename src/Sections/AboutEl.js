  ...
  const aboutEl = [
    {
      ...
      title: "Best Price",
      text: "You can shop with confidence, knowing that you're getting the finest deals on quality second-hand cars.",
    },
    {
      icon: (
        <svg
      ...
      text: "You can trust that your transactions are confidential and protected. Your security is our top priority.",
    },
    {
      icon: (
        <svg
      ...
      text: "We're here to make your car-buying experience as smooth and informed as possible.",
    },
    {
      icon: (
        <svg
      ...
      title: "Test Drive",
      text: "We believe in putting you in the driver's seat, both figuratively and literally, to make the right choice.",
    },
  ];

  return (
    <div className="about-el-grid">
      {aboutEl.map((el, index) => (
        <div className="about-el-div" key={index}>
          <div className="about-icon-div">{el.icon}</div>
          <h3>{el.title}</h3>
          <p>{el.text}</p>
        </div>
      ))}
